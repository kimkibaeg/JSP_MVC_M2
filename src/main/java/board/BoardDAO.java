...
public class BoardDAO {
	...
	public List<BoardDTO> getBoardList(BoardDTO dto) {
		...
		//        ArrayList에 저장되는 BoardDTO 선언은 while 블락 내부에서 선언
		...
		try {
			...
			// rs 의 각 레코드를 BoardDTO에 저장 ==> 각 각의 DTo를 ArrayList에 저장
				// if, do ~ while		<===>	while
			...
			while (rs.next()) {
				...
				board.setWirte(rs.getString("WRITE"));
